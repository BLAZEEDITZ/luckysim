...
import luckySimLogo from "@/assets/lucky-sim-logo.png";
          ...
          >
            <Card glow="gold" className="overflow-hidden">
              <CardHeader className="text-center bg-gradient-to-b from-primary/10 to-transparent pb-8">
                <motion.div
                  className="w-20 h-20 mx-auto rounded-2xl flex items-center justify-center shadow-lg mb-4 overflow-hidden"
                  animate={{ rotate: [0, 5, -5, 0] }}
                  transition={{ repeat: Infinity, duration: 3 }}
                >
                  <img src={luckySimLogo} alt="LuckySim Logo" className="w-full h-full object-cover" />
                </motion.div>
