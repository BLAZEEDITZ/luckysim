...
const Card = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & { glow?: "gold" | "emerald" | "purple" | "none" }
>(({ className, glow = "none", ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      glow === "gold" && "glow-gold border-primary/30",
      glow === "emerald" && "glow-emerald border-secondary/30",
      glow === "purple" && "glow-purple border-accent/30",
      className
    )}
    {...props}
  />
